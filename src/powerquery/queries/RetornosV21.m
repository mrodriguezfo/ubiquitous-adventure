let
    ...
    #"Filtered Rows" = Table.SelectRows(#"Changed Type1", each ([Account] = "INTER-PASCOMPOS")),
    #"Removed Columns" = Table.RemoveColumns(#"Filtered Rows",{"TWRR w/ Fees", "TWRR w/Fees M-T-D", "TWRR w/Fees Y-T-D"})
in
    #"Removed Columns"
